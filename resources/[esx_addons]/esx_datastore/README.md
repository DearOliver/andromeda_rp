<h1 align='center'>[ESX] Data Store</a></h1><p align='center'><b><a href='https://discord.esx-framework.org/'>Discord</a> - <a href='https://documentation.esx-framework.org/legacy/installation'>Documentation</a></b></h5>
...
```lua
TriggerEvent('esx_datastore:getSharedDataStore', 'lspd', function(store)
